...
当前版本已改为分层流水线：`fetch -> parse -> summarize -> render -> notify_feishu`。
...
python -m app.summarize --date YYYY-MM-DD --in ./artifacts/canonical --out ./artifacts/brief --provider deepseek --report ./artifacts/reports
