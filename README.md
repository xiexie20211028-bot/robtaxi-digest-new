...
- 国内新增 Agent-first 影子链：Agent 自主研究行业事件；通过 14 天门槛后，国内固定源只保留 10 个监管入口，海外继续使用 legacy。
...
`agent_domestic` profile 保留国内工信部、交通运输部、公安部交管局、市场监管总局召回以及北京、北京经开区、上海、广州、深圳、武汉共 10 个监管入口；海外启用源与 `legacy` 完全一致。
